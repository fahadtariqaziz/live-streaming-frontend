...
import {clearErrors , updatePassword } from "../../actions/userAction";        //ERROR loadUser is not defined   loaduser bhi ek api hai for /me  taake fresh data load ho
...
const UpdatePassword = () => {
    ...
    const [newPassword , setNewPassword] = useState("");   //or set wala jo hai wo OnChange men input ke andar he
    ...
    const updatePasswordSubmit = (e) => {
        ...
        myForm.set("newPassword", newPassword);        //backend men userController men tou ye 3no chaheye updatePAssword men
        myForm.set("confirmPassword", confirmPassword);   
        dispatch(updatePassword(myForm));      
    }

    //const updatePasswordDataChange = (e) => {            //ye jo neeche sab men onChange men diya hai
